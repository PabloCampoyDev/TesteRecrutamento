...
begin
  ...
  try
    ...
    if (FQuery.IsEmpty) then
      raise Exception.Create('Nenhum pedido encontrado! Codigo: '+numero_pedido);
...
begin
  ...
  if numero_pedido <> '' then
  begin
    FQuery.SQL.Text := ' delete from pedido_produtos where numero_pedido = '+numero_pedido;
    try
      FQuery.ExecSQL;
    ...
    FQuery.SQL.Add(' delete from pedido where numero_pedido = '+numero_pedido+' ');
    try
      FQuery.ExecSQL;
    except on e:exception do
      begin
